...
/**
	Temp Sense linking method
*/
void FOCMotor::linkTempSensor(TemperatureSense* _temp_sense) {
  temp_sense = _temp_sense;
}
...
float FOCMotor::motorTemp() {
  // if no sensor linked return previous value ( for open loop )
  if(!temp_sense) return temperature;
  return temp_sense->getTemperature();
}
