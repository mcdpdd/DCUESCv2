...
#include "voltage/TemperatureSense.h"


// monitoring bitmap
#define _MON_TARGET 0b10000000 // monitor target value
#define _MON_VOLT_Q 0b01000000 // monitor voltage q value
#define _MON_VOLT_D 0b00100000 // monitor voltage d value
#define _MON_CURR_Q 0b00010000 // monitor current q value - if measured
#define _MON_CURR_D 0b00001000 // monitor current d value - if measured
#define _MON_VEL    0b00000100 // monitor velocity value
#define _MON_ANGLE  0b00000010 // monitor angle value
#define _MON_TEMP   0b00000001
...
class FOCMotor
{
  public:
    ...
    /**
     * Function linking a motor and a temperature sensor 
     * 
     * @param temp_sense Temperature sensor class wrapper for the FOC algorihtm to read the motor temp
     */
    void linkTempSensor(TemperatureSense* temp_sense);
    ...
    */
    ...
    /** 
      * TemperatureSense link
    */
    TemperatureSense* temp_sense; 
