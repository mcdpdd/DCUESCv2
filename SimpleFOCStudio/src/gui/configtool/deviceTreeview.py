...
class DeviceTreeView(QTreeWidget):
    def __init__(self, parent=None):
        ...
        self.tempSensor = QtWidgets.QTreeWidgetItem(self.generalSettings)
        self.tempSensor.setText(0, 'Temp Sensor')
        self.tempSensor.setIcon(0, GUIToolKit.getIconByName('gear'))
        self.tempSensor.setText(1, '')
    ...
    def refreshDeviceTree(self):
        ...
        self.tempSensor.setText(1,str(self.device.motorTemp))
