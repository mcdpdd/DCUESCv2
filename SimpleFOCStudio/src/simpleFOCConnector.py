...
class SimpleFOCDevice:
    ...
    def configureDevice(self, jsonValue):
        ...
        self.motorTemp = jsonValue['motorTemp']
    ...
    def parseMonitorResponse(self, comandResponse):
        ...
        elif 'temp' in comandResponse:
            self.motorTemp = float(comandResponse.replace('temp:', ''))
